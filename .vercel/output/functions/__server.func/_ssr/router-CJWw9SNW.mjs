...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CJWw9SNW.js
var router_CJWw9SNW_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-C3NanFI0.css";
var APP_NAME = "Ash";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A private ledger for cigarettes, cost, time, and the moments around them."
			},
			{
				name: "theme-color",
				content: "#0c0c0d"
...
var $$splitComponentImporter = () => import("./routes-Dgh_7LjX.mjs");
...
//#endregion
export { getRouter, router_CJWw9SNW_exports as t };
